...
class ImageFilterPickerPage extends StatefulWidget {
  const ImageFilterPickerPage({super.key});

  @override
  State<ImageFilterPickerPage> createState() => _ImageFilterPickerPageState();
}

class _ImageFilterPickerPageState extends State<ImageFilterPickerPage> {
...
class _MyPreviewDecoratorWidgetState extends State<_MyPreviewDecoratorWidget> {
  ...
  Uint8List _applyFilterOnBytes(Uint8List bytes) {
    return imglib.encodeJpg(_filter.applyFilter(imglib.decodeJpg(bytes)!));
