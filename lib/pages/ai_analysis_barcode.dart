...
class BarcodeAnalysisPage extends StatefulWidget {
  const BarcodeAnalysisPage({super.key});

  @override
  State<BarcodeAnalysisPage> createState() => _BarcodeAnalysisPageState();
}

class _BarcodeAnalysisPageState extends State<BarcodeAnalysisPage> {
